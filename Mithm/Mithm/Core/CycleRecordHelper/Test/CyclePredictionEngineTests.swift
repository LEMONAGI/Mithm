...
//        XCTAssertEqual(dateString(prediction.endDate ?? Date()), dateString(expectedEnd), "사용자 입력 기반 예측의 종료일이 기대값과 다릅니다.")
//    }
//    
...
//        XCTAssertEqual(dateString(prediction.endDate ?? Date()), dateString(expectedEnd), "블렌딩된 평균 기간에 기반한 예측 종료일이 기대값과 다릅니다.")
//    }
//}
